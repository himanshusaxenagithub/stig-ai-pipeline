...
The site itself (index.html, site.js, zip.js, demo.html, articles/,
pages.css) is hand-written and is not replaced. This script only
refreshes the data the start page reads.
